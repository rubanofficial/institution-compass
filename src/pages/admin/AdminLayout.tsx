      ...
      `}>
        <div className="h-full flex flex-col">
          ...
          <div className="p-4 border-b border-sidebar-border">
            <Link to="/admin/dashboard" className="flex items-center gap-3 text-sidebar-foreground">
          ...
          <nav className="flex-1 p-4 space-y-1">
            {navItems.map((item) => {
              const isActive = location.pathname === item.path || 
                (item.path === '/admin/complaints' && location.pathname.startsWith('/admin/complaints'));
          ...
          <div className="p-4 border-t border-sidebar-border">
            {admin && (
              <div className="mb-3 px-3">
                ...
                <p className="text-xs text-sidebar-foreground/60 capitalize">{admin.role}</p>
              </div>
            )}
            <Button
              variant="ghost"
